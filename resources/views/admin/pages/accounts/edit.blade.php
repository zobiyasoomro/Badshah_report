        ...
        <div class="page-header">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1><i class="fas fa-edit me-2"></i>Edit Payment Method</h1>
                        <p class="mb-0 opacity-75">Update {{ $paymentMethod->name }}</p>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                <option value="mobile_wallet" {{ old('type', $paymentMethod->type) == 'mobile_wallet' ? 'selected' : '' }}>
                                    Mobile Wallet
                                </option>
                                <option value="bank" {{ old('type', $paymentMethod->type) == 'bank' ? 'selected' : '' }}>
                                    Bank
                                </option>
                            </select>
                            @error('type')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('account_holder_name') is-invalid @enderror" 
                                   ...
                                   value="{{ old('account_holder_name', $paymentMethod->account_holder_name) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('account_iban') is-invalid @enderror" 
                                   id="account_iban" name="account_iban" 
                                   value="{{ old('account_iban', $paymentMethod->account_iban) }}">
                            @error('account_iban')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('branch_code') is-invalid @enderror" 
                                   ...
                                   value="{{ old('branch_code', $paymentMethod->branch_code) }}">
                            @error('branch_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('deep_link_scheme') is-invalid @enderror" 
                                   ...
                                   value="{{ old('deep_link_scheme', $paymentMethod->deep_link_scheme) }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                   ...
                                   value="{{ old('sort_order', $paymentMethod->sort_order) }}" min="1">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        @if($paymentMethod->logo_url)
            <div class="current-logo">
                <img src="{{ $paymentMethod->logo_url }}" alt="{{ $paymentMethod->name }}" 
                     style="max-width: 80px; max-height: 80px; border-radius: 10px; border: 2px solid #e0e0e0; padding: 5px; object-fit: cover;">
            </div>
        @else
            <span class="text-muted">No logo uploaded</span>
        @endif
        <div>
            <label for="logo_path" class="form-label">Upload New Logo</label>
