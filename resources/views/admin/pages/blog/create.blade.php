...
@section('admin_content')
    ...
    <style>
        /* ===== ROOT VARIABLES ===== */
        :root {
            background: linear-gradient(135deg, #2a4563 0%, #2a4563 50%, #1d3348 100%);
                        ...
                        <div class="blog-header">
                            <div class="blog-header-content">
                                <div class="blog-header-left">
                                    ...
                                    <div>
                                        <h1 class="blog-header-title">Create New Blog</h1>
                                        <p class="blog-header-subtitle">Share your story with the world</p>
                                    </div>
                                </div>
                        ...
                        <div class="blog-body">
                            ...
                            <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="input-modern @error('title') is-invalid @enderror" id="title"
                                        name="title" value="{{ old('title') }}" placeholder="Write an amazing blog title..."
                                        required autofocus>
                                    @error('title')
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="upload-area" id="uploadArea">
                                        ...
                                        <p class="upload-text">Choose an image for your blog post</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            console.log('✨ Blog creation form loaded successfully!');
            console.log('💡 Tip: Press Ctrl+S to submit the form');
        });
    </script>
